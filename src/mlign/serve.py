"""`mlign serve` — a tiny local HTTP server for the browser test page.
    ...
    PYTHONPATH=src python -m mlign.serve [--port 8765] [--ckpt models/mlign-v1.pt]
...
def main(argv=None) -> None:
    ...
    ap.add_argument("--ckpt", default=os.environ.get("MLIGN_CKPT", str(ROOT / "models/mlign-v1.pt")))
