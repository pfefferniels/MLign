...
Model checkpoint resolution: --ckpt, else $MLIGN_CKPT, else models/mlign-v2.pt
...
def main(argv=None) -> None:
    ...
    al.add_argument("--ckpt", default=os.environ.get("MLIGN_CKPT", str(ROOT / "models/mlign-v2.pt")))
